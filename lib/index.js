...
const plugin = {
  ...
  apply(ctx) {
    ...
    rpc.handle('openwiki/job/pause', async (args) => pauseJob(args))
    rpc.handle('openwiki/job/resume', async (args) => resumeJob(args))
    ...
    rpc.handle('openwiki/autoupdate/status', async (args) => {
      const workspaceId = String((args && args.workspaceId) ?? '')
      if (workspaceId) {
        const st = autoUpdateOf(workspaceId)
    ...
    rpc.handle('openwiki/kb/config', async (args) => readKbConfig(args))
    rpc.handle('openwiki/kb/config/save', async (args) => saveKbConfig(args))
    rpc.handle('openwiki/kb/import', async (args) => importKbFiles(args))
    rpc.handle('openwiki/kb/files', async (args) => listKbFiles(args))
    rpc.handle('openwiki/kb/delete', async (args) => deleteKbFile(args))
    rpc.handle('openwiki/kb/tree', async (args) => readWikiTree(args, 'personal'))
    rpc.handle('openwiki/kb/page', async (args) => readWikiPage(args, 'personal'))
    rpc.handle('openwiki/kb/overview', async (args) => readWikiOverview(args, 'personal'))
